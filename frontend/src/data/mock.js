...
export const howItWorksSteps = [
  ...
  },
  {
    ...
    description: "Browse available tasks and complete simple activities from your phone.",
    icon: "CheckSquare"
  },
  {
    step: 3,
...
export const faqData = [
  ...
  },
  {
    ...
    answer: "Tasks include surveys, app testing, watching videos, social media engagement, and simple data entry. All tasks are straightforward and can be completed from your phone."
  },
  {
...
export const appStoreLinks = {
  ios: "#", // Will be updated with actual links
  android: "#",
  comingSoon: true
};
